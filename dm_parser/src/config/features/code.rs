...
impl CodeConfig {
    ...
    pub fn with_options(options: CodeOptions) -> Self {
        ...
        if let Some(default_language_for_unspecified) = options.default_language_for_unspecified {
            config.default_language_for_unspecified = default_language_for_unspecified;
        }
        if let Some(default_language_for_inline) = options.default_language_for_inline {
